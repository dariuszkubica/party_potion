...
abstract class _CocktailDto implements CocktailDto {
  const factory _CocktailDto(
      ...
      required final String? strImageAttribution,
      required final String? strCreativeCommonsConfirmed,
      required final DateTime? dateModified}) = _$_CocktailDto;
