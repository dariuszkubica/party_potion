...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {User? user, Status status, bool isCreatingAccount, String errorMessage});
}
...
class _$_AuthState implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(user: $user, status: $status, isCreatingAccount: $isCreatingAccount, errorMessage: $errorMessage)';
  }
