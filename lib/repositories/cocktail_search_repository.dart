        ...
        return CocktailModel(
          ...
          ingredientsList: [
            IngredientModel(
              ...
              ingredientMesure: coctailsDto.drinks.first.strMeasure1.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient2.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure2.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient3.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure3.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient4.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure4.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient5.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure5.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient6.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure6.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient7.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure7.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient8.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure8.toString(),
            ),
            IngredientModel(
              ingredientName:
                  coctailsDto.drinks.first.strIngredient9.toString(),
              ingredientMesure: coctailsDto.drinks.first.strMeasure9.toString(),
            ),
            IngredientModel(
              ingredientName:
